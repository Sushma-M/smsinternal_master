...
@Service
public class SMSQueryExecutorServiceImpl implements SMSQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(SMSQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("SMSWMQueryExecutor")
