...
/**
* Specifies methods used to obtain and modify TradeCertificate related information
* which is stored in the database.
*/
@Repository("SMS.TradeCertificateDao")
public class TradeCertificateDao extends WMGenericDaoImpl <TradeCertificate, Integer> {
