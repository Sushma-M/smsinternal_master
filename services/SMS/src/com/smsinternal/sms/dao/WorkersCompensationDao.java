...
/**
* Specifies methods used to obtain and modify WorkersCompensation related information
* which is stored in the database.
*/
@Repository("SMS.WorkersCompensationDao")
public class WorkersCompensationDao extends WMGenericDaoImpl <WorkersCompensation, Integer> {
