...
/**
* Specifies methods used to obtain and modify PublicLiability related information
* which is stored in the database.
*/
@Repository("SMS.PublicLiabilityDao")
public class PublicLiabilityDao extends WMGenericDaoImpl <PublicLiability, Integer> {
