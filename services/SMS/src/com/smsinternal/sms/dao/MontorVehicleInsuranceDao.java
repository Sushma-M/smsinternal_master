...
/**
* Specifies methods used to obtain and modify MontorVehicleInsurance related information
* which is stored in the database.
*/
@Repository("SMS.MontorVehicleInsuranceDao")
public class MontorVehicleInsuranceDao extends WMGenericDaoImpl <MontorVehicleInsurance, Integer> {
