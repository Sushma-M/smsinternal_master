...
/**
* Specifies methods used to obtain and modify SupplierServices related information
* which is stored in the database.
*/
@Repository("SMS.SupplierServicesDao")
public class SupplierServicesDao extends WMGenericDaoImpl <SupplierServices, Integer> {
