...
/**
* Specifies methods used to obtain and modify Jjrusers related information
* which is stored in the database.
*/
@Repository("SMS.JjrusersDao")
public class JjrusersDao extends WMGenericDaoImpl <Jjrusers, Integer> {
