...
/**
* Specifies methods used to obtain and modify ServiceTypes related information
* which is stored in the database.
*/
@Repository("SMS.ServiceTypesDao")
public class ServiceTypesDao extends WMGenericDaoImpl <ServiceTypes, Integer> {
