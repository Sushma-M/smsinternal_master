...
Application.$controller("gridCountriesController", ["$scope",
	function($scope) {
		"use strict";
...
Application.$controller("gridStatesController", ["$scope",
	function($scope) {
		"use strict";
		$scope.ctrlScope = $scope;
	}
...
Application.$controller("gridServicesController", ["$scope",
	function($scope) {
		"use strict";
		$scope.ctrlScope = $scope;
	}
...
Application.$controller("gridUsersController", ["$scope",
	function($scope) {
		"use strict";
		$scope.ctrlScope = $scope;
	}
